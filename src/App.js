...
function App() {
  ...
  return (
    <div className="App">
      ...
      <SelectImage memeCurrentVal={memeCurrentVal} setMemeCurrentVal={setMemeCurrentVal} memeMaxVal={memeMaxVal} /> <br />
      <AccessAPI apiData={apiData} setApiData={setApiData} memeCurrentVal={memeCurrentVal} setMemeMaxVal={setMemeMaxVal} />
      <RenderTextOverImage apiData={apiData} memeCurrentVal={memeCurrentVal} topMemeText={topMemeText} bottomMemeText={bottomMemeText} />
